...
abstract class AppLocalizations {
  ...
  /// No description provided for @acknowledgingAlert.
  ///
  /// In en, this message translates to:
  /// **'Acknowledging alert…'**
  String get acknowledgingAlert;

  /// No description provided for @alertAcknowledged.
  ///
  /// In en, this message translates to:
  /// **'Alert acknowledged. Opening case timeline.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Write a factual update for authorized operations.'**
  String get noteHint;
  ...
  /// No description provided for @noteSent.
  ///
  /// In en, this message translates to:
  /// **'Note added to case timeline.'**
  String get noteSent;
